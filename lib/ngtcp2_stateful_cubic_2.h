#ifndef NGTCP2_STATEFUL_CUBIC_2_H
#define NGTCP2_STATEFUL_CUBIC_2_H
...
/* ngtcp2_scubic2_cc is Stateful CUBIC congestion controller. */
typedef struct ngtcp2_scubic2_cc {
  ngtcp2_cc_base ccb;
...
typedef struct ngtcp2_scubic2_state {
